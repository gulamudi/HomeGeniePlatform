-- Get preferred partners - partners who have worked with the customer before
-- For the same service category, who are verified and available
...
BEGIN
    ...
    available_partners AS (
        ...
        AND v_service_category = ANY(pp.services)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Created preferred partners function for customer booking history';
END $$;
